...
Welcome to the OpenShift 4 Disconnected Workshop! Here you'll learn about operating without anaesthetic. an OpenShift 4 cluster in a disconnected network, for our purposes today that will be a network without access to the internet (even through a proxy or firewall).
